...
class Manager {
  public:
    ...
    Manager(Manager * orig) { 
      ...
      copyArray(orig->getExtendedBoard(),this->_extColor);
      copyArray(orig->getDefState(),this->_defState);
      copyArray(orig->getCandyBoard(),this->_candyboard);
      copyArray(orig->getGameState(),this->_gameState);
